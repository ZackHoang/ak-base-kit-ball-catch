...
#define SCREEN_TRAN(target, scr_obj) scr_mng_tran(target, scr_obj)

#define SCREEN_DISPATCH(msg) scr_mng_dispatch(msg)

#define SCREEN_NONE_UPDATE_MASK() scr_mng_contain_screen_none_update_mark()

#define BALL_CATCH_RENDER_AND_PROCESS_TICK 80

extern void scr_mng_ctor(scr_mng_t *scr_mng, screen_f init_scr,
