...
#define HSI_VALUE                                                                 \
	((uint32_t)16000000) /*!< Value of the Internal High Speed oscillator in Hz.  \
...
#define LSI_VALUE                                                              \
	((uint32_t)37000) /*!< Value of the Internal Low Speed oscillator in Hz    \
						   The real value may vary depending on the variations \
						   in voltage and temperature.  */
#endif
...
#define FLASH_OBR_SPRMOD                                                                           \
	((uint32_t)0x00000100)							/*!< Selection of protection mode of WPRi bits \
...
#define FLASH_WRPR1_WRP                                                            \
	((uint32_t)0xFFFFFFFF) /*!< Write Protection bits (available only in STM32L1xx \
...
#define RCC_AHBENR_FLITFEN                                                                     \
	((uint32_t)0x00008000)						 /*!< FLITF clock enable (has effect only when \
...
#define RCC_AHBLPENR_FLITFLPEN                                                                        \
	((uint32_t)0x00008000)							 /*!< Flash Interface clock enabled in sleep mode \
