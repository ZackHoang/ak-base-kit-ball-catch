...
#define IS_PWR_PVD_LEVEL(LEVEL)                                                                                                                                 \
	(((LEVEL) == PWR_PVDLevel_0) || ((LEVEL) == PWR_PVDLevel_1) || ((LEVEL) == PWR_PVDLevel_2) || ((LEVEL) == PWR_PVDLevel_3) || ((LEVEL) == PWR_PVDLevel_4) || \
	 ((LEVEL) == PWR_PVDLevel_5) || ((LEVEL) == PWR_PVDLevel_6) || ((LEVEL) == PWR_PVDLevel_7))
/**
 * @}
 */
...
#define IS_PWR_VOLTAGE_SCALING_RANGE(RANGE) (((RANGE) == PWR_VoltageScaling_Range1) || ((RANGE) == PWR_VoltageScaling_Range2) || ((RANGE) == PWR_VoltageScaling_Range3))
/**
 * @}
 */
...
#define IS_PWR_GET_FLAG(FLAG) \
	(((FLAG) == PWR_FLAG_WU) || ((FLAG) == PWR_FLAG_SB) || ((FLAG) == PWR_FLAG_PVDO) || ((FLAG) == PWR_FLAG_VREFINTRDY) || ((FLAG) == PWR_FLAG_VOS) || ((FLAG) == PWR_FLAG_REGLP))
