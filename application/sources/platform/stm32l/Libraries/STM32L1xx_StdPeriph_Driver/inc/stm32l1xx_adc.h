...
#define IS_ADC_POWER_DOWN(DWON) (((DWON) == ADC_PowerDown_Delay) || ((DWON) == ADC_PowerDown_Idle) || ((DWON) == ADC_PowerDown_Idle_Delay))
/**
 * @}
 */
...
#define IS_ADC_PRESCALER(PRESCALER) (((PRESCALER) == ADC_Prescaler_Div1) || ((PRESCALER) == ADC_Prescaler_Div2) || ((PRESCALER) == ADC_Prescaler_Div4))
/**
 * @}
 */
...
#define IS_ADC_EXT_TRIG_EDGE(EDGE)                                                                                                               \
	(((EDGE) == ADC_ExternalTrigConvEdge_None) || ((EDGE) == ADC_ExternalTrigConvEdge_Rising) || ((EDGE) == ADC_ExternalTrigConvEdge_Falling) || \
...
#define IS_ADC_EXT_TRIG(REGTRIG)                                                                                                                \
	(((REGTRIG) == ADC_ExternalTrigConv_T9_CC2) || ((REGTRIG) == ADC_ExternalTrigConv_T9_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T2_CC3) || \
	 ((REGTRIG) == ADC_ExternalTrigConv_T2_CC2) || ((REGTRIG) == ADC_ExternalTrigConv_T3_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T4_CC4) || \
	 ((REGTRIG) == ADC_ExternalTrigConv_T2_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T3_CC1) || ((REGTRIG) == ADC_ExternalTrigConv_T3_CC3) || \
	 ((REGTRIG) == ADC_ExternalTrigConv_T4_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T6_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_Ext_IT11))
/**
 * @}
 */
...
#define IS_ADC_CHANNEL(CHANNEL)                                                                                                                                           \
	(((CHANNEL) == ADC_Channel_0) || ((CHANNEL) == ADC_Channel_1) || ((CHANNEL) == ADC_Channel_2) || ((CHANNEL) == ADC_Channel_3) || ((CHANNEL) == ADC_Channel_4) ||      \
	 ((CHANNEL) == ADC_Channel_5) || ((CHANNEL) == ADC_Channel_6) || ((CHANNEL) == ADC_Channel_7) || ((CHANNEL) == ADC_Channel_8) || ((CHANNEL) == ADC_Channel_9) ||      \
	 ((CHANNEL) == ADC_Channel_10) || ((CHANNEL) == ADC_Channel_11) || ((CHANNEL) == ADC_Channel_12) || ((CHANNEL) == ADC_Channel_13) || ((CHANNEL) == ADC_Channel_14) || \
	 ((CHANNEL) == ADC_Channel_15) || ((CHANNEL) == ADC_Channel_16) || ((CHANNEL) == ADC_Channel_17) || ((CHANNEL) == ADC_Channel_18) || ((CHANNEL) == ADC_Channel_19) || \
	 ((CHANNEL) == ADC_Channel_20) || ((CHANNEL) == ADC_Channel_21) || ((CHANNEL) == ADC_Channel_22) || ((CHANNEL) == ADC_Channel_23) || ((CHANNEL) == ADC_Channel_24) || \
	 ((CHANNEL) == ADC_Channel_25) || ((CHANNEL) == ADC_Channel_27) || ((CHANNEL) == ADC_Channel_28) || ((CHANNEL) == ADC_Channel_29) || ((CHANNEL) == ADC_Channel_30) || \
...
#define IS_ADC_SAMPLE_TIME(TIME)                                                                                                                               \
	(((TIME) == ADC_SampleTime_4Cycles) || ((TIME) == ADC_SampleTime_9Cycles) || ((TIME) == ADC_SampleTime_16Cycles) || ((TIME) == ADC_SampleTime_24Cycles) || \
	 ((TIME) == ADC_SampleTime_48Cycles) || ((TIME) == ADC_SampleTime_96Cycles) || ((TIME) == ADC_SampleTime_192Cycles) || ((TIME) == ADC_SampleTime_384Cycles))
/**
 * @}
 */
...
#define IS_ADC_DELAY_LENGTH(LENGTH)                                                                                                                                   \
	(((LENGTH) == ADC_DelayLength_None) || ((LENGTH) == ADC_DelayLength_Freeze) || ((LENGTH) == ADC_DelayLength_7Cycles) || ((LENGTH) == ADC_DelayLength_15Cycles) || \
	 ((LENGTH) == ADC_DelayLength_31Cycles) || ((LENGTH) == ADC_DelayLength_63Cycles) || ((LENGTH) == ADC_DelayLength_127Cycles) || ((LENGTH) == ADC_DelayLength_255Cycles))
...
#define IS_ADC_EXT_INJEC_TRIG_EDGE(EDGE)                                                                                                                        \
	(((EDGE) == ADC_ExternalTrigInjecConvEdge_None) || ((EDGE) == ADC_ExternalTrigInjecConvEdge_Rising) || ((EDGE) == ADC_ExternalTrigInjecConvEdge_Falling) || \
...
#define IS_ADC_EXT_INJEC_TRIG(INJTRIG)                                                                                                                          \
	(((INJTRIG) == ADC_ExternalTrigInjecConv_T9_CC1) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T9_TRGO) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T2_TRGO) || \
	 ((INJTRIG) == ADC_ExternalTrigInjecConv_T2_CC1) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T3_CC4) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T4_TRGO) ||  \
	 ((INJTRIG) == ADC_ExternalTrigInjecConv_T4_CC1) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T4_CC2) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T4_CC3) ||   \
	 ((INJTRIG) == ADC_ExternalTrigInjecConv_T10_CC1) || ((INJTRIG) == ADC_ExternalTrigInjecConv_T7_TRGO) || ((INJTRIG) == ADC_ExternalTrigInjecConv_Ext_IT15))
/**
 * @}
 */
...
#define IS_ADC_INJECTED_CHANNEL(CHANNEL) \
	(((CHANNEL) == ADC_InjectedChannel_1) || ((CHANNEL) == ADC_InjectedChannel_2) || ((CHANNEL) == ADC_InjectedChannel_3) || ((CHANNEL) == ADC_InjectedChannel_4))
/**
 * @}
 */
...
#define IS_ADC_ANALOG_WATCHDOG(WATCHDOG)                                                                                                                                        \
	(((WATCHDOG) == ADC_AnalogWatchdog_SingleRegEnable) || ((WATCHDOG) == ADC_AnalogWatchdog_SingleInjecEnable) || ((WATCHDOG) == ADC_AnalogWatchdog_SingleRegOrInjecEnable) || \
	 ((WATCHDOG) == ADC_AnalogWatchdog_AllRegEnable) || ((WATCHDOG) == ADC_AnalogWatchdog_AllInjecEnable) || ((WATCHDOG) == ADC_AnalogWatchdog_AllRegAllInjecEnable) ||         \
...
#define IS_ADC_GET_FLAG(FLAG)                                                                                                                                                    \
	(((FLAG) == ADC_FLAG_AWD) || ((FLAG) == ADC_FLAG_EOC) || ((FLAG) == ADC_FLAG_JEOC) || ((FLAG) == ADC_FLAG_JSTRT) || ((FLAG) == ADC_FLAG_STRT) || ((FLAG) == ADC_FLAG_OVR) || \
