...
#define IS_OPAMP_ALL_PERIPH(PERIPH) (((PERIPH) == OPAMP_Selection_OPAMP1) || ((PERIPH) == OPAMP_Selection_OPAMP2) || ((PERIPH) == OPAMP_Selection_OPAMP3))
...
#define IS_OPAMP_INPUT(INPUT) (((INPUT) == OPAMP_Input_NMOS) || ((INPUT) == OPAMP_Input_PMOS))
...
#define IS_OPAMP_RANGE(RANGE) (((RANGE) == OPAMP_PowerRange_Low) || ((RANGE) == OPAMP_PowerRange_High))
