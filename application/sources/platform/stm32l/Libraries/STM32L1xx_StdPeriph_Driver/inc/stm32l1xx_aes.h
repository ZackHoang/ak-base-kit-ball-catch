...
#define IS_AES_MODE(OPERATION) \
	(((OPERATION) == AES_Operation_Encryp) || ((OPERATION) == AES_Operation_KeyDeriv) || ((OPERATION) == AES_Operation_Decryp) || ((OPERATION) == AES_Operation_KeyDerivAndDecryp))
...
#define IS_AES_CHAINING(CHAINING) (((CHAINING) == AES_Chaining_ECB) || ((CHAINING) == AES_Chaining_CBC) || ((CHAINING) == AES_Chaining_CTR))
/**
 * @}
 */
...
#define IS_AES_DATATYPE(DATATYPE) (((DATATYPE) == AES_DataType_32b) || ((DATATYPE) == AES_DataType_16b) || ((DATATYPE) == AES_DataType_8b) || ((DATATYPE) == AES_DataType_1b))
/**
 * @}
 */
...
#define IS_AES_DMA_TRANSFER(TRANSFER) (((TRANSFER) == AES_DMATransfer_In) || ((TRANSFER) == AES_DMATransfer_Out) || ((TRANSFER) == AES_DMATransfer_InOut))
/**
 * @}
 */
