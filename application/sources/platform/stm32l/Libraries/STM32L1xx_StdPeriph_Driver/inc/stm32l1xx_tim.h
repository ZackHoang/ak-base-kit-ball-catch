...
#define IS_TIM_ALL_PERIPH(PERIPH)                                                                                                                              \
	(((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM6) || ((PERIPH) == TIM7) || ((PERIPH) == TIM9) || \
	 ((PERIPH) == TIM10) || ((PERIPH) == TIM11))

/* LIST1: TIM2, TIM3, TIM4, TIM5, TIM9, TIM10 and TIM11 */
#define IS_TIM_LIST1_PERIPH(PERIPH) \
	(((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM9) || ((PERIPH) == TIM10) || ((PERIPH) == TIM11))

/* LIST3: TIM2, TIM3, TIM4 and TIM5 */
#define IS_TIM_LIST3_PERIPH(PERIPH) (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5))

/* LIST2: TIM2, TIM3, TIM4, TIM5 and TIM9 */
#define IS_TIM_LIST2_PERIPH(PERIPH) (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM9))
...
#define IS_TIM_LIST4_PERIPH(PERIPH) (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM6) || ((PERIPH) == TIM7))

/* LIST6: TIM2, TIM3, TIM9, TIM10 and TIM11 */
#define IS_TIM_LIST6_PERIPH(PERIPH) (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM9) || ((PERIPH) == TIM10) || ((PERIPH) == TIM11))

/* LIST3: TIM2, TIM3, TIM4, TIM5 and TIM9 */
#define IS_TIM_LIST7_PERIPH(PERIPH) (((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) || ((PERIPH) == TIM5) || ((PERIPH) == TIM9))
...
#define IS_TIM_OC_MODE(MODE)                                                                                                                                              \
	(((MODE) == TIM_OCMode_Timing) || ((MODE) == TIM_OCMode_Active) || ((MODE) == TIM_OCMode_Inactive) || ((MODE) == TIM_OCMode_Toggle) || ((MODE) == TIM_OCMode_PWM1) || \
	 ((MODE) == TIM_OCMode_PWM2))
#define IS_TIM_OCM(MODE)                                                                                                                                                  \
	(((MODE) == TIM_OCMode_Timing) || ((MODE) == TIM_OCMode_Active) || ((MODE) == TIM_OCMode_Inactive) || ((MODE) == TIM_OCMode_Toggle) || ((MODE) == TIM_OCMode_PWM1) || \
	 ((MODE) == TIM_OCMode_PWM2) || ((MODE) == TIM_ForcedAction_Active) || ((MODE) == TIM_ForcedAction_InActive))
/**
 * @}
 */
...
#define IS_TIM_GET_IT(IT) (((IT) == TIM_IT_Update) || ((IT) == TIM_IT_CC1) || ((IT) == TIM_IT_CC2) || ((IT) == TIM_IT_CC3) || ((IT) == TIM_IT_CC4) || ((IT) == TIM_IT_Trigger))
/**
 * @}
 */
...
#define IS_TIM_DMA_BASE(BASE)                                                                                                                                        \
	(((BASE) == TIM_DMABase_CR1) || ((BASE) == TIM_DMABase_CR2) || ((BASE) == TIM_DMABase_SMCR) || ((BASE) == TIM_DMABase_DIER) || ((BASE) == TIM_DMABase_SR) ||     \
	 ((BASE) == TIM_DMABase_EGR) || ((BASE) == TIM_DMABase_CCMR1) || ((BASE) == TIM_DMABase_CCMR2) || ((BASE) == TIM_DMABase_CCER) || ((BASE) == TIM_DMABase_CNT) || \
	 ((BASE) == TIM_DMABase_PSC) || ((BASE) == TIM_DMABase_ARR) || ((BASE) == TIM_DMABase_CCR1) || ((BASE) == TIM_DMABase_CCR2) || ((BASE) == TIM_DMABase_CCR3) ||   \
	 ((BASE) == TIM_DMABase_CCR4) || ((BASE) == TIM_DMABase_DCR) || ((BASE) == TIM_DMABase_OR))
/**
 * @}
 */
...
#define IS_TIM_TRIGGER_SELECTION(SELECTION)                                                                                                                             \
	(((SELECTION) == TIM_TS_ITR0) || ((SELECTION) == TIM_TS_ITR1) || ((SELECTION) == TIM_TS_ITR2) || ((SELECTION) == TIM_TS_ITR3) || ((SELECTION) == TIM_TS_TI1F_ED) || \
	 ((SELECTION) == TIM_TS_TI1FP1) || ((SELECTION) == TIM_TS_TI2FP2) || ((SELECTION) == TIM_TS_ETRF))
...
#define IS_TIM_GET_FLAG(FLAG)                                                                                                                       \
	(((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) || ((FLAG) == TIM_FLAG_CC3) || ((FLAG) == TIM_FLAG_CC4) || \
	 ((FLAG) == TIM_FLAG_Trigger) || ((FLAG) == TIM_FLAG_CC1OF) || ((FLAG) == TIM_FLAG_CC2OF) || ((FLAG) == TIM_FLAG_CC3OF) || ((FLAG) == TIM_FLAG_CC4OF))
...
#define IS_TIM_REMAP(TIM_REMAP)                                                                                                                                              \
	(((TIM_REMAP) == TIM2_TIM10_OC) || ((TIM_REMAP) == TIM2_TIM5_TRGO) || ((TIM_REMAP) == TIM3_TIM11_OC) || ((TIM_REMAP) == TIM3_TIM5_TRGO) || ((TIM_REMAP) == TIM9_GPIO) || \
	 ((TIM_REMAP) == TIM9_LSE) || ((TIM_REMAP) == TIM9_TIM3_TRGO) || ((TIM_REMAP) == TIM9_TS_IO) || ((TIM_REMAP) == TIM10_GPIO) || ((TIM_REMAP) == TIM10_LSI) ||             \
	 ((TIM_REMAP) == TIM10_LSE) || ((TIM_REMAP) == TIM10_RTC) || ((TIM_REMAP) == TIM10_RI) || ((TIM_REMAP) == TIM10_ETR_LSE) || ((TIM_REMAP) == TIM10_ETR_TIM9_TRGO) ||      \
	 ((TIM_REMAP) == TIM11_GPIO) || ((TIM_REMAP) == TIM11_MSI) || ((TIM_REMAP) == TIM11_HSE_RTC) || ((TIM_REMAP) == TIM11_RI) || ((TIM_REMAP) == TIM11_ETR_LSE) ||           \
