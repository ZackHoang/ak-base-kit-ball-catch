...
#define IS_RCC_MSI_CLOCK_RANGE(RANGE)                                                                                                                           \
	(((RANGE) == RCC_MSIRange_0) || ((RANGE) == RCC_MSIRange_1) || ((RANGE) == RCC_MSIRange_2) || ((RANGE) == RCC_MSIRange_3) || ((RANGE) == RCC_MSIRange_4) || \
	 ((RANGE) == RCC_MSIRange_5) || ((RANGE) == RCC_MSIRange_6))
...
#define IS_RCC_PLL_MUL(MUL)                                                                                                                                              \
	(((MUL) == RCC_PLLMul_3) || ((MUL) == RCC_PLLMul_4) || ((MUL) == RCC_PLLMul_6) || ((MUL) == RCC_PLLMul_8) || ((MUL) == RCC_PLLMul_12) || ((MUL) == RCC_PLLMul_16) || \
	 ((MUL) == RCC_PLLMul_24) || ((MUL) == RCC_PLLMul_32) || ((MUL) == RCC_PLLMul_48))
/**
 * @}
 */
...
#define IS_RCC_SYSCLK_SOURCE(SOURCE) \
	(((SOURCE) == RCC_SYSCLKSource_MSI) || ((SOURCE) == RCC_SYSCLKSource_HSI) || ((SOURCE) == RCC_SYSCLKSource_HSE) || ((SOURCE) == RCC_SYSCLKSource_PLLCLK))
/**
 * @}
 */
...
#define IS_RCC_HCLK(HCLK)                                                                                                                                        \
	(((HCLK) == RCC_SYSCLK_Div1) || ((HCLK) == RCC_SYSCLK_Div2) || ((HCLK) == RCC_SYSCLK_Div4) || ((HCLK) == RCC_SYSCLK_Div8) || ((HCLK) == RCC_SYSCLK_Div16) || \
	 ((HCLK) == RCC_SYSCLK_Div64) || ((HCLK) == RCC_SYSCLK_Div128) || ((HCLK) == RCC_SYSCLK_Div256) || ((HCLK) == RCC_SYSCLK_Div512))
/**
 * @}
 */
...
#define IS_RCC_GET_IT(IT)                                                                                                                                              \
	(((IT) == RCC_IT_LSIRDY) || ((IT) == RCC_IT_LSERDY) || ((IT) == RCC_IT_HSIRDY) || ((IT) == RCC_IT_HSERDY) || ((IT) == RCC_IT_PLLRDY) || ((IT) == RCC_IT_MSIRDY) || \
...
#define IS_RCC_RTCCLK_SOURCE(SOURCE)                                                                                                                                   \
	(((SOURCE) == RCC_RTCCLKSource_LSE) || ((SOURCE) == RCC_RTCCLKSource_LSI) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div2) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div4) || \
...
#define IS_RCC_MCO_SOURCE(SOURCE)                                                                                                                       \
	(((SOURCE) == RCC_MCOSource_NoClock) || ((SOURCE) == RCC_MCOSource_SYSCLK) || ((SOURCE) == RCC_MCOSource_HSI) || ((SOURCE) == RCC_MCOSource_MSI) || \
	 ((SOURCE) == RCC_MCOSource_HSE) || ((SOURCE) == RCC_MCOSource_PLLCLK) || ((SOURCE) == RCC_MCOSource_LSI) || ((SOURCE) == RCC_MCOSource_LSE))
/**
 * @}
 */
...
#define IS_RCC_MCO_DIV(DIV) (((DIV) == RCC_MCODiv_1) || ((DIV) == RCC_MCODiv_2) || ((DIV) == RCC_MCODiv_4) || ((DIV) == RCC_MCODiv_8) || ((DIV) == RCC_MCODiv_16))
/**
 * @}
 */
...
#define IS_RCC_FLAG(FLAG)                                                                                                                                        \
	(((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_MSIRDY) || ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_LSERDY) ||  \
	 ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_PINRST) || ((FLAG) == RCC_FLAG_PORRST) || ((FLAG) == RCC_FLAG_SFTRST) || ((FLAG) == RCC_FLAG_IWDGRST) || \
	 ((FLAG) == RCC_FLAG_WWDGRST) || ((FLAG) == RCC_FLAG_LPWRRST) || ((FLAG) == RCC_FLAG_OBLRST) || ((FLAG) == RCC_FLAG_LSECSS))
